...
export const viewMap: ViewMap = {
    ...
    "AdminSettingSwaggerView" : () => import('@/views/setting/swagger/index.vue'),
    "AdminAuthorityAuthGroupView" : () => import('@/views/authority/auth-group'),
    "AdminAuthorityAuthView" : () => import('@/views/authority/auth'),
};
